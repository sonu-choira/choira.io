...
function ShowBookingDetails({ setSelectTab }) {
  ...
  useEffect(() => {
    if (data.state?.productData) {
      ...
      console.log(`production data is set now  ======> ${productionData._id}`);
    } else {
      setProductionData({});
    }
              ...
              <div>
                <div className={style.addNewStudioinputBox}>
                  ...
                  <input
                    ...
                    id="ProductionName"
                    name="ProductionName"
                    value={productionData.serviceFullName}
                ...
                <div className={style.addNewStudioinputBox}>
                  ...
                  {isEditMode ? (
                    <Select
                      ...
                      style={customStyles}
                      options={productionData?.package?.amenites?.map(
                        (item) => ({
                          value: item.name,
                          label: item.name,
                        })
