...
//   bannerLength,
// }) {
//   const [studioName, setStudioName] = useState("Select Studio");
...
//                   {values.forr === "page" && editMode.current == false && (
...
//                   {editMode.current && values.forr === "page" && studioName ? (
//                     <div className={style.customInput}>
//                       <label htmlFor="UserName">Studio Name</label>
//                       {studioName ? (
//                         <SearchSelectInput
